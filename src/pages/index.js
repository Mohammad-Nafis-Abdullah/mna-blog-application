  ...
  return (
    <>
      ...
      <section className='flex flex-wrap gap-5 justify-center max-w-6xl mx-auto px-3 pt-5 sm:pt-10 pb-5'>
        ...
        <div className='basis-full flex flex-wrap items-center gap-5 justify-between'>
        
          <label htmlFor="myPost" className='inline-flex gap-2 items-center pt-1 cursor-pointer '>
            <input type="checkbox" className='h-5 w-5' name="" id="myPost" />
            <span className='font-bold select-none'>Show My Post</span>
          </label>

          <div className='inline-flex rounded overflow-hidden grow max-w-sm'>
          ...
          <Link href='/create-blog' className='inline-flex items-center hover:underline decoration-2 underline-offset-2'>
